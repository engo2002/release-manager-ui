...
export class HttpResponseInterceptor implements HttpInterceptor {
  private noSessionRefresh = ["refresh", "loginSuccess", "logout", "heartbeat"];
  private errorMessage = "";
  private refreshTokenInProgress = false;
  private tokenRefreshedSource = new Subject();
  private tokenRefreshed$ = this.tokenRefreshedSource.asObservable();
  private noSnackbar: string[] = ["validateToken", "logout"];
  ...
  private refreshToken(): Observable<any> {
    ...
    return this.authService.refreshAccessTokenForLoggedInUser$().pipe(
      tap((refresh) => {
        ...
        this.authService.setAuthTokenInBrowser(refresh.accessToken, refresh.refreshExpiresIn);
        this.authService.setRefreshTokenInBrowser(refresh.refreshToken, refresh.refreshExpiresIn);
        this.authService.setSessionIdInBrowser(refresh.session.sessionId, refresh.refreshExpiresIn);
        this.authService.setUserIdInBrowser(refresh.session.userId, refresh.refreshExpiresIn);
